...
<section class="disclaimer-section mt-28">
    <marquee behavior="scroll" direction="left" scrollamount="5">
        <strong>
            ...
            <span class="">⚠️Important: All information provided on
                this website is for general educational purposes only.</span>
            <span class="">• Investing in financial markets involves risks. Always
                consult with a professional advisor.</span>
            <span class=" ">• Past performance is not indicative of future results. Use
                this data at your own discretion.</span>
            <span class=" ">• BSMR does not take responsibility for any financial losses
...
<x-stockmarquee />
    ...
    <section class="relative bg-gray-100 py-12 w-full px-4 sm:px-6 mt-[0.5rem] lg:px-8 ">
